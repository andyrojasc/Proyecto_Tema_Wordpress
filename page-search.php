<?php get_header(); ?>
    ...
    <div class="container"><?php echo $_GET['text'];?>
        ...
        <div class="row alineado">
            <div class="col-lg-2 col-md-12 col-sm-12">
                <img style="width: 200px;" src="https://yt3.ggpht.com/a-/AAuE7mDaIPSwLi2eUtSdUZ0Knhmpfg6vTCe09VKiLw=s900-mo-c-c0xffffffff-rj-k-no" class="img-fluid " alt="">
            </div>
            <div class="col-lg-8 col-md-12 col-sm-12 margenTexto">
                <h3>HOLA</h3>
                <br>
                <h6 class="margenFecha"><?php echo $_GET['text'];?></h6>
                <br>
                <a href=""><button type="button" class="btnSlid">Ver mas</button></a>
            </div>
        </div>
        <hr>
        <div class="row alineado">
            ...
            <div class="col-lg-8 col-md-12 col-sm-12 margenTexto">
                <h3>HOLA</h3>
                <br>
                <h6 class="margenFecha">20 de marzo del 2018</h6>
                <br>
                <a href=""><button type="button" class="btnSlid">Ver mas</button></a>
            </div>
        </div>  
